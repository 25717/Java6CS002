...
/**The class implements the "Comparable" interface, which means it has a method called "compareTo" that can be used to compare two domino objects based on their values*/
public class Domino implements Comparable<Domino> {
public int high; //Higher int value of the domino tile
public int low;  // Lower int value of the domino tile
public int hx;	
public int hy;		/*representing the x and y coordinates of the high and low ends of the domino tile*/
public int lx;
public int ly;	
...
/** method to return a string representation of the domino, its values and its placemnt status*/
...
/** returns a boolean indicating whether the domino is a horizontal or a vertical position.*/

public boolean ishl() {
return hy==ly;
}

/** compares two dominos based on their values and return a value less than, equal to or greater than the other domino*/

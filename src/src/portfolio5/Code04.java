...
public class Code04 {
	...
	public static void main(String[] args) {
	    ...
	    footballList.stream().filter(football -> football. getTotalPoints() == 68)
	        .forEach(System.out::println);

	    System.out.println();
	    System.out.println("Clubs with 73 points");
	    footballList.stream().filter(football -> football. getTotalPoints() == 73).forEach(System.out::println);
